...
export default async function ProductsPage(props: { searchParams?: Promise<{ q?: string; cursor?: string; take?: string; page?: string; pageSize?: string; showDeleted?: string }> }) {
