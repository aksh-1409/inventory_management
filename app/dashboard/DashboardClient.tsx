...
export default function DashboardClient({
  ...
  const matrixWarehouses = userWarehouseId
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      <div
        ...
        style={{
          ...
          pointerEvents: 'none',
          zIndex: 0,
          background: 'radial-gradient(ellipse at top, var(--accent) 0%, transparent 65%)',
        }}
      />
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="card" style={{ overflow: 'hidden', marginBottom: 24 }}>
          <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--border)' }}>
            <h2 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text-heading)' }}>
              Stock Matrix
            </h2>
            <p style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>
              Products x Warehouses
            </p>
          </div>
                  ...
                  <tr key={p.id} style={{ borderBottom: '1px solid var(--border)' }}>
                    ...
                    {matrixWarehouses.map((w) => {
                      ...
                      return (
                        <td
                          key={w.id}
                          style={{ padding: '12px 24px', textAlign: 'center', background: bg }}
                        >
                          <span
                            className="tabular"
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <span
                        ...
                        style={{
                          ...
                          color: t.status === 'PENDING' ? 'var(--warning)' : 'var(--accent)',
                          fontSize: 12,
                        }}
                      >
                        {t.status}
