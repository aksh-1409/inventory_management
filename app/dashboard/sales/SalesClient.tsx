...
export default function SalesClient({
  ...
  const [optimisticSales, addOptimistic] = useOptimistic(
    sales,
  ...
  const phoneMatches = existingCustomers.filter(
    (c) => c.phone && phoneInput && c.phone.toLowerCase().includes(phoneInput.toLowerCase())
  );
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <EmptyState
          icon={ShoppingCart}
          title={qParam ? 'No sales match your search' : 'No sales yet'}
          description={
            qParam
              ...
              >
                <thead>
                  <tr style={{ borderBottom: '1px solid var(--border)' }}>
                    {['Product', 'SKU', 'Warehouse', 'Qty', 'Date', 'Reference', 'Invoice'].map(
                      (h) => (
                        <th
                          key={h}
                          style={{
                    ...
                    <tr key={sale.id} style={{ borderBottom: '1px solid var(--border)' }}>
                      ...
                      <td data-label="Invoice" style={{ padding: '16px 24px' }}>
                        {(() => {
                          ...
                          const up =
                            sale.unitPrice ??
                            products.find((p) => p.id === sale.product.id)?.price ??
                            0;
                          return (
                            <SalesInvoiceDownload
                              sale={{
                                id: sale.id,
                                quantity: qty,
                                unitPrice: up,
                ...
                <CustomSelect
                  ...
                  onChange={(v) => {
                    ...
                    setForm({
                      ...form,
                      productId: v,
                      unitPrice: p ? String(p.price) : form.unitPrice,
                    });
                  }}
                ...
                <div style={{ position: 'relative' }}>
                  <Phone
                    style={{
                      ...
                      width: 14,
                      height: 14,
                      color: matchedCustomer ? 'var(--success)' : 'var(--text-muted)',
                    }}
                  />
                  <input
                    className="input"
                    ...
                    onFocus={() => {
                      if (phoneInput.length >= 2) setShowPhoneDropdown(true);
                    }}
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ fontSize: 13, fontWeight: 500, color: 'var(--accent)' }}>
                        New Customer &mdash; will be saved with this sale
                      </span>
                    </div>
                    <input
                      className="input"
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    value={form.unitPrice || selectedProduct?.price || ''}
