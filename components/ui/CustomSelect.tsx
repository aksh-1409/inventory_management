...
export function CustomSelect({ options, value, onChange, placeholder = 'Select...', required, id }: Props) {
            ...
            options.map((opt, i) => (
              <button
                ...
                style={{
                  ...
                  background: i === focusedIndex ? 'rgba(59,158,255,0.12)' : opt.value === value ? 'rgba(139,92,246,0.2)' : 'transparent',
                  border: 'none',
                  cursor: 'pointer',
                  textAlign: 'left',
                  fontFamily: 'inherit',
