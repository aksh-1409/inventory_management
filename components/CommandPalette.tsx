...
const DEFAULT_ACTIONS: Action[] = [
  ...
  },
  {
    ...
    keywords: ['receiving', 'receive', 'inbound'],
  },
  {
    id: 'nav-users',
    label: 'Go to Users',
    ...
    keywords: ['users', 'admins', 'operators'],
    adminOnly: true,
  },
  {
    id: 'nav-api-keys',
  ...
  },
  {
    ...
    keywords: ['settings', 'webhooks', 'config'],
    adminOnly: true,
  },
];
...
export function CommandPalette({ isAdmin = false }: CommandPaletteProps) {
  ...
  const filtered = DEFAULT_ACTIONS.filter((a) => !a.adminOnly || isAdmin).filter((a) => {
