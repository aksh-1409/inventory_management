...
const styles = StyleSheet.create({
  ...
  badge: { padding: '4 8', borderRadius: 4, backgroundColor: '#e8f4fd', fontSize: 9, fontWeight: 'bold', color: '#0369a1' },
  ...
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', padding: '10 12', backgroundColor: '#f5f5f5', borderRadius: 4, marginTop: 4 },
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={{ flex: 1, textAlign: 'center', fontSize: 10, color: '#1a1a1a' }}>{data.quantity}</Text>
            <Text style={{ flex: 1, textAlign: 'right', fontSize: 10, color: '#1a1a1a' }}>${data.unitPrice.toFixed(2)}</Text>
            <Text style={{ flex: 1, textAlign: 'right', fontSize: 10, color: '#1a1a1a', fontWeight: 'bold' }}>${data.total.toFixed(2)}</Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={{ flex: 3, fontWeight: 'bold', color: '#1a1a1a' }}>Grand Total</Text>
            <Text style={{ flex: 1 }} />
            <Text style={{ flex: 1 }} />
            <Text style={{ flex: 1, textAlign: 'right', fontWeight: 'bold', color: '#1a1a1a', fontSize: 12 }}>${data.total.toFixed(2)}</Text>
          </View>
        </View>
