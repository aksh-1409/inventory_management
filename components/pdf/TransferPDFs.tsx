      ...
      <Page size="A4" style={receivingStyles.page}>
          ...
          <View style={receivingStyles.section}>
            ...
            {data.receivedAt && (
              <View style={receivingStyles.row}>
                ...
                <Text style={receivingStyles.value}>
        ...
        <View style={receivingStyles.section}>
          ...
          <View style={receivingStyles.tableHeader}>
            ...
            <Text style={{ ...receivingStyles.tableHeaderText, flex: 1, textAlign: 'center' }}>
              SKU
            </Text>
            <Text style={{ ...receivingStyles.tableHeaderText, flex: 1, textAlign: 'right' }}>
              Ordered
            </Text>
            <Text style={{ ...receivingStyles.tableHeaderText, flex: 1, textAlign: 'right' }}>
              Received
        ...
        <View style={receivingStyles.section}>
          ...
          <View style={receivingStyles.row}>
            ...
            <Text style={{ ...receivingStyles.value, color: '#2e7d32' }}>
              {data.quantityReceived} units
            </Text>
          </View>
          {data.damagedQuantity > 0 && (
            <View style={receivingStyles.row}>
              <Text style={receivingStyles.label}>Damaged</Text>
              <Text style={{ ...receivingStyles.value, color: '#d32f2f' }}>
                {data.damagedQuantity} units (written off)
              </Text>
            </View>
          )}
          <View style={receivingStyles.row}>
          ...
          <View style={receivingStyles.row}>
            ...
            <Text
              style={{
                ...receivingStyles.value,
                color: data.quantityInitiated - data.quantityReceived > 0 ? '#d32f2f' : '#2e7d32',
              }}
            >
              {data.quantityInitiated - data.quantityReceived === 0
                ? 'None'
                : `${data.quantityInitiated - data.quantityReceived} units short`}
            </Text>
          </View>
          {unitCost > 0 && (
            <View style={receivingStyles.row}>
              <Text style={receivingStyles.label}>Total Cost</Text>
              <Text style={{ ...receivingStyles.value, fontSize: 12 }}>
                ${totalCost.toFixed(2)}
              </Text>
            </View>
          )}
        ...
        <View style={receivingStyles.footer}>
          ...
          <Text style={receivingStyles.footerText}>
